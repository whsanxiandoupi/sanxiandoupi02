...
QT_MOC_LITERAL(4, 20, 3) // "msg"

    },
    "SendFile\0done\0\0text\0msg"
};
...
void SendFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->text((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::done)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::text)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SendFile::text(QByteArray _t1)
{
