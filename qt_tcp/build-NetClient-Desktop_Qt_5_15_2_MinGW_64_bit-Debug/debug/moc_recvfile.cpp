...
QT_MOC_LITERAL(5, 32, 8) // "gameOver"

    },
    "RecvFile\0connectOk\0\0message\0msg\0"
    "gameOver"
};
...
void RecvFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->message((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RecvFile::connectOk)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RecvFile::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RecvFile::message)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (RecvFile::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RecvFile::gameOver)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void RecvFile::connectOk()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void RecvFile::message(QByteArray _t1)
{
